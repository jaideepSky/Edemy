...
function CourseDetail() {
  ...
  return courseData ? (
    <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36  pt-20 text-left">
              ...
              >
                ...
                >
                  <div className="flex items-center gap-2">
                    <img 
                    className={`transform transition-transform ${openChapterIndex[index]? 'rotate-180' : ''}`}
                ...
                <div
                  className={`overflow-hidden transition-all duration-300 ${
                    openChapterIndex[index] ? "max-h-96" : "max-h-0"
                  } `}
                >
      ...
      {/* Right Column */}
      <div className="z-10 rounded-t md:rounded-none overflow-hidden  max-w-[424px] bg-white min-w-[300px] sm:min-w-[420px] shadow-[0px 4px  15px 2px rgba(0,0,0,0.1)]">
        ...
        <div className="flex gap-3 items-center pt-2">
          <p className="text-gray-800 md:text-4xl text-2xl font-semibold">{import.meta.env.VITE_CURRENCY }{(courseData.coursePrice - courseData.discount * courseData.coursePrice / 100).toFixed(2)}</p>
          <p className="md:text-lg text-gray-500 line-through">{import.meta.env.VITE_CURRENCY }{courseData.coursePrice}</p>
